...
/**
 * Lightweight, dependency-free snap carousel.
 * Children become snap-aligned items; desktop gets hover arrow controls.
 */
    ...
    <div className={cn("group/carousel relative", className)}>
      ...
      <button
        ...
        className={cn(
          ...
          canLeft ? "opacity-0 group-hover/carousel:opacity-100" : "pointer-events-none opacity-0"
        )}
      >
      ...
      <button
        ...
        className={cn(
          ...
          canRight ? "opacity-0 group-hover/carousel:opacity-100" : "pointer-events-none opacity-0"
        )}
      >
